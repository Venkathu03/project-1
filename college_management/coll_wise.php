        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="needs-validation mt-2 text-start" id='submit-form' action="dwnldcoll_wise.php" method="get">
                     <div class = "col-md-10">
...
<div class="mt-3">
 <a href="dwnldcoll_wise.php?Institution_Name=<?=  $rows['Institution_Name'];  ?>"> <button class= "btn float-end" style = "background:#87AFC7; color:white;"> Download </button></a> 

<button onclick="window.location.href='report.html'" class="btn btn-primary "type="button">Back</button>
</div>
   </form>
                    </div>
