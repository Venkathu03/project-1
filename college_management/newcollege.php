...
$sql = "SELECT * FROM institution_details WHERE institution_name = '$institution_name'";
...
<!-- icon --> 
 ...
 <table  border="1px" style="line-height: 50px;" id="mytableID" class="table table-striped sampleTable">
    ...
    <td><a href="<?php echo $rows['File']; ?>"><button onClick="checkFile(this.form)"  style="color:white; border-style:none; border-radius:5px; padding:5px 10px; cursor: pointer; background-color:green;"> Download </button></a></td>
    <td> <a href="coll_edit.php?Institution_Name=<?= $rows['Institution_Name'];  ?>"> <button class= "btn update" style = "background:#87AFC7; color:white; transition: .5s;"> update </button></a> </td>
...
<small class = "back">Go Back</small>
 ...
 <script>
    ...
    function checkFile(form_tbl){

var fileVal = form_tbl.elements['File'].value;
